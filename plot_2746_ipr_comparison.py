"""
Generate cutlet plots for 2746r00 (F-type, 0.035" shift) at three IPR values
to compare against 8896r00 (F-type, 0.100" shift) and 2226r1 (6-3).
"""
import sys
import os
...
def plot_cutlets_for_file(ax, filepath, label, ipr_override=None):
    ...
    clip_box = box(-gage_radius, min(all_y) - 2.0, 0, max(all_y) + 2.0)
...
# --- Main ---
base = "Bit Designs/2746"
files = [
    (f"{base}/2746r00 @ 0.100 in_rev Min Engagement v8.01.xlsm", "2746r00 @ 0.100"),
    (f"{base}/2746r00 @ 0.250 in_rev Min Engagement v8.01.xlsm", "2746r00 @ 0.250"),
    (f"{base}/2746r00 @ 0.500 in_rev Min Engagement v8.01.xlsm", "2746r00 @ 0.500"),
]
...
plt.suptitle('2746r00 F-Type (0.035" shift) — Cutlet Comparison at Three IPR Values', fontsize=14, fontweight='bold')
plt.tight_layout(rect=[0, 0.06, 1, 0.95])
plt.savefig('cutlet_plots_2746_ipr_comparison.png', dpi=150, bbox_inches='tight')
print("\n\nSaved: cutlet_plots_2746_ipr_comparison.png")

# Summary
print("\n" + "="*80)
print("SUMMARY: 2746r00 (F-type, 0.035\" shift) per-blade total primary cutlet areas")
print("="*80)
